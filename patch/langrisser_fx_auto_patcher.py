...
OUTPUT_TRACK2_SHA256 = "E9F3E5D6C6AAD6C15FB554A440F2D8F9D22AE59756D3ABF11E5CF1941D3B04B3"
...
class PatcherWindow:
    def __init__(self, root: tk.Tk):
        ...
        ttk.Label(frame, text="Langrisser FX 한국어 패치", font=("맑은 고딕", 15, "bold")).grid(
