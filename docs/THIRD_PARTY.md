...
- **Galmuri7**: referenced by the 8×8 bottom-HUD builder; the working tree carries an SIL Open Font License notice. The font file is withheld from this candidate until the owner confirms the intended redistribution set and attribution.
